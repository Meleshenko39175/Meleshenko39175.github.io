var background = function (window) {
  ...
  window.opspark.makeBackground = function (app, ground) {
    ...
    function render() {
      ...
      var backgroundFill = draw.rect(canvasWidth, canvasHeight, "#1500C0");
      ...
      moon.y = 100;
      for (var starindex = 0; starindex < 150; starindex++) {
      ...
      for (var buildingindex = 0; buildingindex < 7; ++buildingindex) {
        var buildingHeight = 300 - Math.random() * 150;
        var building = draw.rect(75, buildingHeight, "LightGray", "Black", 1);
        building.x = 200 * buildingindex;
    ...
    function update() {
      ...
      for (
        ...
        currentBuilding.x -= 0.4;
        if (currentBuilding.x < -100) {
